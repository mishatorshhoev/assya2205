...
function openFullscreenImage(element) {
  ...
  // Блокируем прокрутку страницы при открытом полноэкранном режиме
...
// Наблюдаем за всеми колонками и фактами
document.addEventListener('DOMContentLoaded', function() {
  const animatedElements = document.querySelectorAll('.column, .fact-item, .hobby-item');
